...
"x86_64-linux-thread-multi-5.11.0-1028-azure" or
	die "Errno architecture (x86_64-linux-thread-multi-5.11.0-1028-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
